          ...
          <div className='footer-data'>
              ...
              <span className='copyright'>&copy;{year}</span> michał bodys
               ...
               <ul className='social-list'>
                ...
                <li><a  href='https://drive.google.com/file/d/1vRdFkgDJjWdkQ73HwHSr6BV4INqB9vgd/view?usp=sharing'><svg xmlns="http://www.w3.org/2000/svg" class="socials icon icon-tabler   icon-tabler-file-cv" width="24" height="24" viewBox="5 2 24 24" stroke-width="1" stroke="black" fill="currentColor" stroke-linecap="round" stroke-linejoin="round">
