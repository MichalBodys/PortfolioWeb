          ...
          <div className='footer-data'>
              ...
              <span className='copyright'>&copy;{year}</span> michał bodys
               ...
               <ul className='social-list'>
                ...
                <li><a  href='https://drive.google.com/file/d/1tWBYcHs3Al-IWglHBHWy31Pg26iiTYYm/view?usp=sharing'><svg xmlns="http://www.w3.org/2000/svg" className="socials icon icon-tabler   icon-tabler-file-cv" width="24" height="24" viewBox="5 2 24 24" strokeWidth="1" stroke="black" fill="currentColor" strokeLinecap="round" strokeLinejoin="round">
